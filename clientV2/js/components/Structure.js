        ...
        this.elem = createDOM(
            `<div class="legal">
                ...
                <p> Thanks to all the amazing developers and artists that provide open resources, 
                    so that I can develop this project happily.
                    <a href="https://github.com/QGH11/QGH-Portfolio-Website#attribution" target="_blank">More info on Github Readme</a>
                </p>
...
export class NotFound {
    constructor() {
        this.elem = createDOM(
            `<div class="notFound">
                <div class="notFound-bg"><h1>404</h1></div>
                ...
                <div class="page-control">
                <a href="#/"><button class="button">Back to Home Page</button><a/>
                </div>
            </div>`
        );
    }
